...
set terminal pdf size 8,8;set output 'energies.pdf'
...
set multiplot layout 2,2
    ...
    set yrange[-6:4]
    set ylabel "Adimensional Energy/particles (E_{adim}/n_{p})"
    p '../results/result_03.dat' u 1:2 w l lw 2 lc 'red' smooth mcsplines t 'potential energy',\
    '../results/result_03.dat' u 1:3 w l lw 2 lc 'blue' smooth mcsplines t 'kinetic energy',\
    '../results/result_03.dat' u 1:($2+$3) w l lw 2 lc 'green' smooth mcsplines t 'total energy'

    set autoscale y
    set ylabel "Adimensional center of mass velocity (v_{cm})"
