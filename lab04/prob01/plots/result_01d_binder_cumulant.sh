...
GNUTERM = "qt"
x = 0.0
set terminal pdf size 8,8;set output 'result_01d_binder_cumulant.pdf'
set multiplot layout 2,2
    set title "Cumulantes de Binder para distintas dimensiones: Version 1"     
    set xlabel "T_{adim}/T_{adim}^c";set ylabel "U_2"
    set grid;set key font ",16";set xlabel  font ",16" ;set ylabel  font ",16"
    ## Last datafile plotted: "result_01d_binder_cumulant_40x40.dat"
    p '../results/result_01d_binder_cumulant_10x10.dat' every 8  u 1:2 w lp ps 1.5 pt 7 lc rgb 'red' smooth mcsplines t 'laticce=10x10',\
    ...
    '../results/result_01d_binder_cumulant_40x40.dat' every 2  u 1:2 w lp ps 1.5 pt 7 lc rgb 'blue' smooth mcsplines t 'laticce=40x40',\
    '../results/result_01d_binder_cumulant_10x10.dat' every 2  u 1:2 w p ps 1.5 pt 7 lc rgb 'red' notitle,\
