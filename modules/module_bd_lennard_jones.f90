! module of borwnian dynamic to lennard jones potential
! gfortran -c module_precision.f90 module_mt19937.f90 module_bd_lennard_jones.f90
module module_bd_lennard_jones
    ...
    function static_structure_factor(n_p,density,x_vector,y_vector,z_vector)
        ...
        do i=1,n_p
            ! cambiar en caso de tener otro vector de onda 2pi/a(-1,1,-1)
...
end module module_bd_lennard_jones