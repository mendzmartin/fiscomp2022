! make clean && make molecular_dynamic_lennard_jones_02.o && ./molecular_dynamic_lennard_jones_02.o
program molecular_dynamic_lennard_jones_02
    ...
    ! ESTACIONARIO
    open(10,file='../results/md_fluctuations.dat',status='replace',action='write',iostat=istat)
    ...
    open(20,file='../results/md_fluctuations_vs_time.dat',status='replace',action='write',iostat=istat)
...
end program molecular_dynamic_lennard_jones_02