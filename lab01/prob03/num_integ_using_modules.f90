...
! COMPILATION RUL
!----------------------------------------------------------
! gfortran -g3 -Wall -Wextra -Wconversion num_integ_using_modules.f90 -o num_integ_using_modules && ./num_integ
! gfortran -o num_integ_using_modules ../../module_presition.f90 ../../module_functions.f90 ../../module_num_integrals.f90 num_integ_using_modules.f90 && ./num_integ_using_modules
!----------------------------------------------------------
