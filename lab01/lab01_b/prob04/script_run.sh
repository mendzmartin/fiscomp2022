...
#	pth_mod=''${pth_mod_01}' '${pth_mod_03}' '${pth_mod_07}' '${pth_mod_09}' '${pth_mod_04}'' # RUN 1,2
	pth_mod=''${pth_mod_01}' '${pth_mod_03}' '${pth_mod_07}' '${pth_mod_09}' '${pth_mod_10}'' # RUN 3

# object code name
#	ob_cod_name='pullen_edmonds.o'	# RUN 1
#	ob_cod_name='poincare_sections.o'	# RUN 2
	ob_cod_name='poincare_sections_02' #RUN 3

# fortran code name
#	f90_cod_name='pullen_edmonds.f90' 	# RUN 1
#	f90_cod_name='poincare_sections.f90' # RUN 2
	f90_cod_name='poincare_sections_02.f90' # RUN 3
...
#	gfortran ${flags} -o ${ob_cod_name} ${pth_mod} ${f90_cod_name} ${ld_path} ${lib01}
	gfortran ${flags} -o ${ob_cod_name} ${pth_mod} ${f90_cod_name} 						# RUN 1,2,3
