...
# module paths
	...
	pth_mod_03='../../modules/module_gauss.f90'
	pth_mod_04='../../modules/module_num_integrals.f90'
	pth_mod_05='../../modules/module_numerical_error.f90'

	pth_mod=${pth_mod_01}' '${pth_mod_02}' '${pth_mod_03}' '${pth_mod_04}' '${pth_mod_05}

# object code name
	ob_cod_name='num_integ_gauss.o'

# fortran code name
	f90_cod_name='num_integ_gauss.f90'
...
# execution
	gfortran ${flags} -o ${ob_cod_name} ${pth_mod} ${f90_cod_name} && ./${ob_cod_name}
